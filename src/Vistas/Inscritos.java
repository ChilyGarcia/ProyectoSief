...
public class Inscritos extends javax.swing.JFrame {
    ...
    public void mostrar(String codigo)
    {
        ...
        String sql = "SELECT  codigo_programa, periodo, nombre_del_programa, inscritos FROM nuevoprograma WHERE codigo_programa = "+codigo ;
        Statement st;
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnGraficar, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 140, -1, -1));
    ...
    private void btnGraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGraficarActionPerformed
        ...
        if(lista.equals("107859 - Tecnico profesional en soporte informatico"))
        {
            ...
            ventana.lblNombre.setText("inscritos"); 
