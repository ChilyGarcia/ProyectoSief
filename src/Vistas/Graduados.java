 ...
 * @author jugad
 */
public class Graduados extends javax.swing.JFrame {

    /**
     * Creates new form Graduados
     */
    ImageIcon icon;
    public Graduados() {
        initComponents();
    ...
    public void mostrar(String codigo)
    {
        ...
        String sql = "SELECT  codigo_programa, periodo, nombre_del_programa, graduados FROM nuevoprograma WHERE codigo_programa = "+codigo ;
        Statement st;
    ...
    private void initComponents() {
        ...
        getContentPane().add(comboConsultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 331, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 220, 574, 190));
    ...
    private void btnGraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGraficarActionPerformed
        ...
        if(lista.equals("107859 - Tecnico profesional en soporte informatico"))
        {
            ...
            ventana.lblNombre.setText("graduados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Graduados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
